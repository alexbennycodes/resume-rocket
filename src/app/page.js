  ...
  return (
    <main className="container min-h-screen flex items-center justify-center">
      <div className="relative text-center flex flex-col items-center h-full justify-center">
        <button
          className="group relative rounded-full p-px text-sm/6 text-zinc-200 duration-300 hover:text-zinc-100 hover:shadow-glow mb-5"
          type="button"
        >
          <span className="absolute inset-0 overflow-hidden rounded-full">
            <span className="absolute inset-0 rounded-full bg-[image:radial-gradient(75%_100%_at_50%_0%,rgba(248, 56, 56, 0.6)_0%,rgba(56,189,248,0)_75%)] opacity-100 transition-opacity duration-500 group-hover:opacity-100"></span>
          </span>
        ...
        <h1 className="bg-gradient-to-br text-white dark:text-white bg-clip-text text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold tracking-tight drop-shadow-2xl lg:max-w-5xl">
